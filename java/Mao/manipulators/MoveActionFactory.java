 ...
 */
 ...
 public class MoveActionFactory extends ManipulatorActionFactory
 {
 	//constructs the TermDragAction whose information is stored in bytes
 	...
 	{
 		return new MoveAction().byteArrayLength();
 	}
 }