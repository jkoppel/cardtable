/**
 *For Mao online; creates the appropriate ManipulatorAction type
 *						from a byte array
 *Author: James Koppel
 ...
 */
 ...
 public class InitDragActionFactory extends ManipulatorActionFactory
 {
 	//constructs the InitDragAction whose information is stored in bytes
 	public ManipulatorAction buildFromByteArray(byte[] bytes)
 	{
 		InitDragAction m = new InitDragAction();
 		m.read(bytes);
 		return m;
 	}
 	...
 	{
 		return new InitDragAction().byteArrayLength();
 	}
 }