 ...
 */
 ...
 public class DropActionFactory extends ManipulatorActionFactory
 {
 	//constructs the DropAction whose information is stored in bytes
 	public ManipulatorAction buildFromByteArray(byte[] bytes)
 	{
 		DropAction m = new DropAction();
 		m.read(bytes);
 		return m;
 	}
 	...
 	{
 		return new DropAction().byteArrayLength();
 	}
 }